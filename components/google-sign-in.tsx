...
export function GoogleSignIn({clientId,onSuccess}:{clientId:string;onSuccess:()=>void}){
 const holder=useRef<HTMLDivElement>(null),success=useRef(onSuccess);useEffect(()=>{success.current=onSuccess;},[onSuccess]);
